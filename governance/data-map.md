...
## קישורים יוצאים
שמונה-עשר אתרי מתכונים, 36 קישורים בסך הכול (כרטיס + פוטר לכל אחד), כולם תחת `robertog62.github.io`. **לכולם `rel="noopener noreferrer"`** — נבדק 21.09.2026: 0 קישורים יוצאים בלי התכונה. קודם היה `target="_blank"` בלי rel, מה שמאפשר reverse tabnabbing.
