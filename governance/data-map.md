...
## קישורים יוצאים
שישה קישורים לאתרי המתכונים, כולם תחת `robertog62.github.io`. **כולם קיבלו `rel="noopener noreferrer"`** (12 קישורים תוקנו) — קודם היה `target="_blank"` בלי rel, מה שמאפשר reverse tabnabbing.
